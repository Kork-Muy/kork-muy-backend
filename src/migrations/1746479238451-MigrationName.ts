...
export class MigrationName1746479238451 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_quests" ("questsId" uuid NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_250d2d9e7440bc6738e24ac3c3c" PRIMARY KEY ("questsId", "userId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_0de695a6a9bcef83ccd1d1daa8" ON "user_quests" ("questsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_f489a5a5d968cfb35e44815fbd" ON "user_quests" ("userId") `);
        await queryRunner.query(`CREATE TABLE "event_coordinators" ("eventsId" uuid NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_69aaa6dd782e473fff4ca77693e" PRIMARY KEY ("eventsId", "userId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_0de67d7f643615271aeab63490" ON "event_coordinators" ("eventsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_f7fc2f12f7335c98694002934c" ON "event_coordinators" ("userId") `);
        await queryRunner.query(`ALTER TABLE "auctions" ADD CONSTRAINT "FK_fe6306cfdf68911c1cc945e5787" FOREIGN KEY ("ticketId") REFERENCES "tickets"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "user_quests" ADD CONSTRAINT "FK_0de695a6a9bcef83ccd1d1daa81" FOREIGN KEY ("questsId") REFERENCES "quests"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "user_quests" ADD CONSTRAINT "FK_f489a5a5d968cfb35e44815fbd9" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "event_coordinators" ADD CONSTRAINT "FK_0de67d7f643615271aeab634908" FOREIGN KEY ("eventsId") REFERENCES "events"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "event_coordinators" ADD CONSTRAINT "FK_f7fc2f12f7335c98694002934c0" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "event_coordinators" DROP CONSTRAINT "FK_f7fc2f12f7335c98694002934c0"`);
        await queryRunner.query(`ALTER TABLE "event_coordinators" DROP CONSTRAINT "FK_0de67d7f643615271aeab634908"`);
        await queryRunner.query(`ALTER TABLE "user_quests" DROP CONSTRAINT "FK_f489a5a5d968cfb35e44815fbd9"`);
        await queryRunner.query(`ALTER TABLE "user_quests" DROP CONSTRAINT "FK_0de695a6a9bcef83ccd1d1daa81"`);
        await queryRunner.query(`ALTER TABLE "tickets" DROP CONSTRAINT "FK_8a101375d173c39a7c1d02c9d7d"`);
        await queryRunner.query(`ALTER TABLE "auctions" DROP CONSTRAINT "FK_fe6306cfdf68911c1cc945e5787"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f7fc2f12f7335c98694002934c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0de67d7f643615271aeab63490"`);
        await queryRunner.query(`DROP TABLE "event_coordinators"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f489a5a5d968cfb35e44815fbd"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0de695a6a9bcef83ccd1d1daa8"`);
